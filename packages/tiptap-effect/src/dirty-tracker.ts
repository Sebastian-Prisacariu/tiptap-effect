 ...
 * the runtime — there's no per-editor finalizer here because dirty state is a
 * UX concern that benefits from surviving brief editor recreates (e.g.
 * StrictMode unmount-remount cycles).
 */
